...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F0F2F9] dark:bg-[#0f1117] relative overflow-hidden font-sans px-4 py-8 transition-colors duration-200">
      {/* Background blobs */}
      ...
      >
        {/* Card */}
        <div className="bg-white dark:bg-[#1a1d27] rounded-3xl shadow-[0_20px_60px_rgba(90,69,255,0.12)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.5)] overflow-hidden border border-transparent dark:border-[#2e3148]">
          ...
          <div className="px-8 pt-6">
            <div className="flex bg-[#F0F2F9] dark:bg-[#252836] rounded-2xl p-1 gap-1">
              <button
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-16 pr-4 py-3.5 bg-[#F0F2F9] dark:bg-[#252836] rounded-2xl text-slate-900 dark:text-slate-100 text-base font-semibold tracking-widest placeholder-slate-400 dark:placeholder-slate-600 outline-none focus:ring-2 focus:ring-[#5A45FF]/30 transition-all"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-4 py-3.5 bg-[#F0F2F9] dark:bg-[#252836] rounded-2xl text-slate-900 dark:text-slate-100 font-medium placeholder-slate-400 dark:placeholder-slate-600 outline-none focus:ring-2 focus:ring-[#5A45FF]/30 transition-all text-sm"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-11 pr-11 py-3.5 bg-[#F0F2F9] dark:bg-[#252836] rounded-2xl text-slate-900 dark:text-slate-100 font-medium placeholder-slate-400 dark:placeholder-slate-600 outline-none focus:ring-2 focus:ring-[#5A45FF]/30 transition-all text-sm"
                        placeholder="••••••••••"
                        required
                      />
                      <button
